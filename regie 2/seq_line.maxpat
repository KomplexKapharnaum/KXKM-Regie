...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 195.5, 31.0, 29.0, 18.0 ],
					"text" : "t #1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 195.5, 7.0, 96.0, 18.0 ],
					"text" : "r autofillsequences"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-151",
					"items" : [ " ", ",", "NIMBY_paq", ",", "NIMBY_RELANCE", ",", "NIMBY_CAMPEMENT", ",", "NIMBY_DEBORDEMENT" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
