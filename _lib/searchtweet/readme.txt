...
Requirements:
----------------
Windows or Mac (Intel or PPC)
Java 6 or higher
Tested with MAX/MSP 5.0

Installation:
----------------
Copy everything in the lib folder under your [maxmsp]/java/lib folder, and copy the searchtweet.class under [maxmsp]/java/classes folder.
...
2. The external searchweet.class uses Twiter4j library (twitter4j-core-2.2.0.jar), an unofficial java library for Twitter, developed by Yusuke Yamamoto. The Twitter4J project, its source code and documentation can be found at:
